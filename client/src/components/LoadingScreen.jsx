...
import './LoadingScreen.css'; // Import the CSS for the animation
  ...
  return (
    <div className="loading-screen">
      <div className="animation01">
        ...
        <div></div>
        <div></div>
        <div className="welcome-text"></div> {/* Added Welcome text */}
      </div>
      ...
      <div className="animation03">
        ...
        <div className="animation04">
          ...
          <div className="task-collector-text">Task Collector</div> {/* Added Task Collector text */}
        </div>
      </div>
